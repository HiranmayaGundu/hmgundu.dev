...
const autoColorModeScript = async (): Promise<string> => {
  ...
  const minifiedCode = await Terser.minify(calledFunction);
  calledFunction = minifiedCode.code ? minifiedCode.code : "";
...
export default class MyDocument extends Document<{ colorModeScript: string }> {
