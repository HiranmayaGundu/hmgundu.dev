...
As part of my job, as I googled for answers like we all do. In the search for answers, I found 
...
Since its my first time building a blog, I first decided the technologies I wanted to use. My only 
constraint was it has to be built with a stack I was not entirely comfortable with. They were:-
