...
Especially data centric systems like databases. Power loss is _not_ an excuse for someone losing money in their
...
Twizzler is an OS that explores this idea. The kernel get's out of the way when manipulating data. They do so by
