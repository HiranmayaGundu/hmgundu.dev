export const meta = {
  ...
  "title": "Unit Tests can still be helpful.",
  "summary": "Unit tests provide the least value for your application. Here is why I still write them."
}
...
That's why react-testing-library is awesome. It reminds you that in the end, what matters is the DOM. So test that. All it 
provides are easy ways to find your element in the DOM, and trigger user events on them.
